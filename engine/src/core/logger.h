 ...
 *
 * @param memory_requirement A pointer to the required memory size of internal state
 * @param state 0 is just requesting the memory requirement, otherwise allocated memory block.

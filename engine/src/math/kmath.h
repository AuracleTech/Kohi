...
/**
 * @brief Returns the dot product between the provided quaternions. Typically used
 * to calculate the difference in direction.
 *
...
// Euler to quaternions, optionally normalize
...
// returns the delta between 2 quaternions, percentage between 1 and 0 to get the desired amount
